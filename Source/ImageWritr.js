    ...
    var PixelRendr = (function () {
                ...
                switch (colors[loc]) {
                    ...
                    case "p":
                        ...
                        if (colors[++loc] === "[") {
                            ...
                            loc = nixloc + 1;
                            digitsize = 0;
                            for (var n = Object.keys(paletteref).length; n >= 1; n /= 10) {
                                ++digitsize;
                            }
                        }
                        else {
        ...
        */
        ...
        PixelRendr.prototype.getDigitSize = function (palette) {
            var digitsize = 0;
            for (var n = palette.length; n >= 1; n /= 10) {
                ++digitsize;
            }
            return digitsize;
        };
    ...
    var ImageWritr = (function () {
        ...
        */
            ...
            for (i in o) {
                if (o[i] !== null && typeof (o[i]) === "object") {
                    if (o[i].constructor !== Uint8ClampedArray) {
                        ...
                        this.processSprite((i !== "normal" ? prevKey + i : prevKey), o[i].length / 4);
                    }
                }
            }
        };
        ...
        ImageWritr.prototype.workerPaletteCollect = function (image, filename, element, src, event) {
            ...
            this.workerPaletteFinish(this.PixelRender.generatePaletteFromRawData(data, true, true), filename, element, src);
        };
        /**
         *
         */
        ...
        ImageWritr.prototype.workerPaletteFinish = function (colors, filename, element, src) {
            ...
            var chooser = this.initializePalette(filename, colors);
            ...
            element.appendChild(setupTextInput("[ [" + colors.join("], [") + "] ]"));
            chooser.click();
            element.setAttribute("palette", this.palette);
        };
        return ImageWritr;
